...
const BannerCarousel = () => {
  ...
  return (
    <div className="flex flex-col-reverse lg:flex-row items-center lg:justify-center mt-4 bg-gradient-to-r from-blue-200 to-purple-200 rounded-lg">
        ...
        >
          {imageSlides.map((slide, index) => (
            <div key={index} className="relative rounded-lg">
              <img src={slide.src} alt={slide.alt} className="w-full h-auto rounded" />
